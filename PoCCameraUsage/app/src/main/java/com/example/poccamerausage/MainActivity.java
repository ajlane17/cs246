...
/*  Done:   1. Detect and Access Camera - Create code to check for the existence of cameras and request access.
    Done:   2. Create a Preview Class - Create a camera preview class that extends SurfaceView and implements
    ...
    Done:   4. Setup Listeners for Capture - Connect listeners for your interface controls to start image or video
    ...
    TODO:   5. Capture and Save Files - Setup the code for capturing pictures or videos and saving the output.
                Mostly done need to check how to only store images in the app and auto delete
    Done:   6. Release the Camera - After using the camera, your application must properly release it for use
